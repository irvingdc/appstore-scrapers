...
async function run(req, res, next) {
	...
	let results = await sc.getResultsList('https://www.25pp.com/ios/search_app_0/',search,'a.app-title')
	let bestResult = await sc.getBestMatch(results,search,'p.app-downs')
