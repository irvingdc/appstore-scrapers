...
async function run(req, res, next) {
	...
	let results = await fn.getResultsList(chromeless,'http://www.anzhi.com/search.php?keyword=',search,'a')
	let bestResult = await fn.getBestMatch(chromeless,results,search,'span.spaceleft')
