...
async function run(req, res, next) {
	...
	let results = await fn.getResultsList(chromeless,'http://shouji.baidu.com/s?wd=',search,'a')
	let bestResult = await fn.getBestMatch(chromeless,results,search,'span.download-num')
