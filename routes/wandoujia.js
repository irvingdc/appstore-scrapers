...
async function run(req, res, next) {
	...
	let results = await sc.getResultsList('http://www.wandoujia.com/search?key=',search,'a')
	let bestResult = await sc.getBestMatch(results,search,"i[itemprop='interactionCount']")
