...
async function run(req, res, next) {
	...
	let results = await fn.getResultsList(chromeless,'http://www.wandoujia.com/search?key=',search,'a')
	let bestResult = await fn.getBestMatch(chromeless,results,search,"i[itemprop='interactionCount']")
