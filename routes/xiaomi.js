...
async function run(req, res, next) {
	...
	let results = await fn.getResultsList(chromeless,'http://app.mi.com/search?keywords=',search,'a')
	let bestResult = await fn.getBestMatch(chromeless,results,search,null)
