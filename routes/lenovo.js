...
async function run(req, res, next) {
	...
	let results = await sc.getResultsList('http://www.lenovomm.com/search/index.html?q=',search,'a')
	let bestResult = await sc.getBestMatch(results,search,'div.detailDownNum')
