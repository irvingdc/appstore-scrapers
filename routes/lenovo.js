...
async function run(req, res, next) {
	...
	let results = await fn.getResultsList(chromeless,'http://www.lenovomm.com/search/index.html?q=',search,'a')
	let bestResult = await fn.getBestMatch(chromeless,results,search,'div.detailDownNum')
